...
namespace Xamasoft.JsonClassGenerator.UI
{
    ...
    {
        private static readonly object[] CodeWriters =
        {
        ...
        private string _lastGeneratedString;
        ...
        private void btnBrowse_Click(object sender, EventArgs e)
        {
            using (var b = new FolderBrowserDialog())
            {
                ...
                b.Description = Resources.FrmCSharpClassGeneration_btnBrowse_Click_Please_select_a_folder_where_to_save_the_generated_files_;
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, Resources.SpecifyOutputDirectory, Text, MessageBoxButtons.OK,
                    MessageBoxIcon.Warning);
                return;
            }
            if (edtNamespace.Text == string.Empty)
            {
                MessageBox.Show(this, Resources.SpecifyNamespace, Text, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            var gen = Prepare();
            if (gen == null) return;
            ...
            {
                MessageBox.Show(this, Resources.CantGenerateCode + ex.Message, Text, MessageBoxButtons.OK,
        ...
        {
            HideCompletionMessage();
            var jsonClipboard = Clipboard.GetText(format: TextDataFormat.UnicodeText);
            if (jsonClipboard != _lastGeneratedString)
            {
            ...
            try
            {
                ...
                using (var sw = new StringWriter())
                {
                    ...
                    gen.GenerateClasses();
                    sw.Flush();
                    _lastGeneratedString = sw.ToString();
                    Clipboard.SetText(_lastGeneratedString);
                }
                messageTimer.Stop();
        ...
        private JsonClassGenerator Prepare()
        {
            ...
            {
                MessageBox.Show(this, Resources.GiveJsonSample, Text, MessageBoxButtons.OK,
                    MessageBoxIcon.Warning);
                edtJson.Focus();
                return null;
            }
            ...
            {
                MessageBox.Show(this, Resources.SpecifyMainClass, Text, MessageBoxButtons.OK,
                    MessageBoxIcon.Warning);
                return null;
            }
            ...
            gen.SecondaryNamespace = radDifferentNamespace.Checked && !string.IsNullOrEmpty(edtSecondaryNamespace.Text)
                ? edtSecondaryNamespace.Text
                : null;
        ...
        private void UpdateStatus()
        {
            if (edtSecondaryNamespace.Text.Contains("JsonTypes") || (edtSecondaryNamespace.Text == string.Empty))
                edtSecondaryNamespace.Text = edtNamespace.Text == string.Empty
                    ? string.Empty
                    : edtNamespace.Text + "." + edtMainClass.Text + "JsonTypes";
